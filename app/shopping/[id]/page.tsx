  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-lg mx-auto px-4 pt-6 pb-28 md:pb-10">
        <div className="mb-6">
          <Link href="/shopping" className="flex items-center gap-1.5 text-sm text-indigo-600 font-medium mb-3 w-fit">
          ...
          <p className="text-sm text-gray-500 mt-1">Liste de courses partagée</p>
        </div>
